module.exports = {
  js: {
    jq: "https://static.bigfoot.xin/libs/jquery/1.9.1/jquery.min.js",
    bs:
      "https://cdnjs.cloudflare.com/ajax/libs/bootstrap/3.3.7/js/bootstrap.min.js",
    bs_hover_dropdown:
    ...
    bdmap:
      "https://api.map.baidu.com/api?v=2.0&ak=gpC6Isg2cPlGiu0DH0NVP6S4oW40vEv4",
    layer_mobile:
      "https://cdnjs.cloudflare.com/ajax/libs/layer/3.1.0/mobile/layer.js",
    swiper:
      "https://cdnjs.cloudflare.com/ajax/libs/Swiper/4.4.2/js/swiper.min.js",
    webcam:
      "https://cdnjs.cloudflare.com/ajax/libs/webcamjs/1.0.23/webcam.min.js",
    jq_qrcode:
  ...
  css: {
    ...
    animate:
      "https://static.bigfoot.xin/libs/animate.css/3.5.2/animate.min.css",
    slick:
